...
with st.form(key='my_form'):
    ...
    user_input = st.text_input("SEO Keywords", placeholder="Provide SEO keywords", key='input')
...
if submit_button:
    ...
    Use keywords closely related to the topic without duplicating any words. 
    Provide a list of potential long-tail keywords for the topic that could be used based on the SEO keyword input provided.
    ...
    Also suggest a few short keywords to find the right images for this blog topic on Unsplash and Freepik. 
    Context: {con}
