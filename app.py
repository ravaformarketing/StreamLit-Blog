...
if submit_button and user_input:
    ...
    Based on the given blog idea and context, what additional information do you require to generate a blog? Generate 5 questions asking for the requirements in a chronological order. Output in a python list.
    \n
    Output format:
    ["","","","",""]
    """
    ...
    template = """You are an expert Blog Writer. Your expertise spans across various industries, considering emotional, technical, psychological aspects related to the topic. 
    ...
    Given a topic, consider all the variations, sub topics, keywords, questions that people search for related to this topic. Iterate on sub topics to choose unique and interesting variations. Do not use buzz words. Ban generic words such as "unveil, unlock, unleash, understand". 
    ...
    Generate 5 blog titles for each type of blog from the given idea (hence, there will be 60 titles in total). Keep the titles short and punchy. They should create curiosity.
